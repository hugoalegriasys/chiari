...
const navItems = [
  ...
  { href: '/productos', label: 'Productos', icon: 'CakeIcon' },
  { href: '/ventas', label: 'Ventas', icon: 'CashIcon' },
  { href: '/compras', label: 'Compras', icon: 'CartIcon' },
  { href: '/produccion', label: 'Produccion', icon: 'FactoryIcon' },
]
...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-bakery-100 px-2 py-1 z-50">
